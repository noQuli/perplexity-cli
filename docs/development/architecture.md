# Perplexity CLI Architecture Overview

This document provides a high-level overview of Perplexity CLI's architecture.

## Core components

Perplexity CLI is primarily composed of two main packages, along with a suite of tools that can be used by the system in the course of handling command-line input:
...
A typical interaction with Perplexity CLI follows this flow:
