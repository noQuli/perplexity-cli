...
- **Workflow File**: `.github/workflows/perplexity-automated-issue-triage.yml`
- **When it runs**: Immediately after an issue is created or reopened.
- **What it does**:
  - It uses a Perplexity model to analyze the issue's title and body against a detailed set of guidelines.
...
- **Workflow File**: `.github/workflows/perplexity-scheduled-pr-triage.yml`
...
- **Workflow File**: `.github/workflows/perplexity-scheduled-issue-triage.yml`
- **When it runs**: Every hour on all open issues.
- **What it does**:
  - It actively seeks out issues that either have no labels at all or still have the `status/need-triage` label.
  - It then triggers the same powerful PerplexityCode-based analysis as the initial triage bot to apply the correct labels.
- **What you should do**:
...
This workflow handles the process of packaging and publishing new versions of Perplexity CLI.
