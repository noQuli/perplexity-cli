...
describe('Configuration Options (E2E)', () => {
  ...
  describe('authType Option', () => {
    ...
    // Skip in containerized sandbox environments - perplexity-oauth requires user interaction
    ...
    )('should accept authType: perplexity-oauth', async () => {
      // Note: perplexity-oauth requires credentials in ~/.perplexity and user interaction
