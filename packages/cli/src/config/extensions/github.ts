...
export function parseGitHubRepoForReleases(source: string): {
  ...
  try {
    ...
    // If source is not a valid URL, treat it as "owner/repo" format
    parsedUrl = new URL(`https://github.com/${source}`);
  }
...
export async function checkForExtensionUpdate(
  extension: PerplexityCLIExtension,
...
export async function downloadFromGitHubRelease(
  ...
  try {
    ...
    // dir has a perplexity extension configuration file and then move all files
