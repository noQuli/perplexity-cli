...
import { PERPLEXITY_DIR } from '@perplexity-cli/perplexity-cli-core';
...
describe('update tests', () => {
  ...
  beforeEach(() => {
    ...
    userExtensionsDir = path.join(tempHomeDir, PERPLEXITY_DIR, 'extensions');
