...
import { Config } from '@perplexity-cli/perplexity-cli-core';
...
vi.mock('@perplexity-cli/perplexity-cli-core', async () => {
  const actual = await vi.importActual('@perplexity-cli/perplexity-cli-core');
  return {
    ...actual,
...
describe('Configuration Integration Tests', () => {
  ...
  beforeEach(() => {
    tempDir = fs.mkdtempSync(path.join(tmpdir(), 'perplexity-code-test-'));
