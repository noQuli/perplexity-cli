...
import { loadServerHierarchicalMemory } from '@perplexity-cli/perplexity-cli-core';
      ...
      action: async (context: CommandContext, args: string) => {
        ...
        try {
          if (config.shouldLoadMemoryFromIncludeDirectories()) {
            ...
            context.ui.setPerplexityMdFileCount(fileCount);
          }
          addItem(
            {
        ...
        if (added.length > 0) {
          const perplexity = config.getPerplexityClient();
          if (perplexity) {
            await perplexity.addDirectoryContext();
          }
          addItem(
            {
              type: MessageType.INFO,
