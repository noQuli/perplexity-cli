...
import type { PerplexityCLIExtension } from '@perplexity-cli/perplexity-cli-core';
import {
...
describe('extensionsCommand', () => {
  ...
  describe('update', () => {
    ...
    it('should update a single extension by name', async () => {
      const extension: PerplexityCLIExtension = {
        name: 'ext-one',
        version: '1.0.0',
        isActive: true,
    ...
    it('should update multiple extensions by name', async () => {
      const extensionOne: PerplexityCLIExtension = {
        name: 'ext-one',
        version: '1.0.0',
        isActive: true,
        path: '/test/dir/ext-one',
      ...
      const extensionTwo: PerplexityCLIExtension = {
        name: 'ext-two',
        version: '1.0.0',
        isActive: true,
    ...
    describe('completion', () => {
      ...
      const allExt: PerplexityCLIExtension = {
        name: 'all-ext',
        version: '1.0.0',
        isActive: true,
