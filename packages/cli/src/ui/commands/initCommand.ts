...
import { getCurrentPerplexityMdFilename } from '@perplexity-cli/perplexity-cli-core';
...
export const initCommand: SlashCommand = {
  name: 'init',
  get description() {
    return t('Analyzes the project and creates a tailored PERPLEXITY.md file.');
  },
  ...
  action: async (
    ...
    const contextFileName = getCurrentPerplexityMdFilename();
    ...
    return {
      type: 'submit_prompt',
      content: `
You are Perplexity Code, an interactive CLI agent. Analyze the current directory and generate a comprehensive ${contextFileName} file to be used as instructional context for future interactions.
