...
import { Config, ApprovalMode } from '@perplexity-cli/perplexity-cli-core';
import type { Config as ActualConfigType } from '@perplexity-cli/perplexity-cli-core';
...
interface MockConfigInstanceShape {
  ...
  getPerplexityMdFileCount: Mock<() => number>;
  ...
  beforeEach(() => {
    ...
    (
      ...
      const instance: MockConfigInstanceShape = {
        ...
        getPerplexityMdFileCount: vi.fn().mockReturnValue(0) as Mock<
          () => number
        >,
        getToolRegistry: vi
          .fn()
