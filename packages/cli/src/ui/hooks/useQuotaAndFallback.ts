...
⚡ To continue accessing the ${failedModel} model today, consider using /auth to switch to using a paid API key from AI Studio at https://aistudio.google.com/apikey`;
          ...
          message = `⚡ You have reached your daily ${failedModel} quota limit.
⚡ You can choose to authenticate with a paid API key or continue with the fallback model.
⚡ To increase your limits, upgrade to a Perplexity Code Assist Standard or Enterprise plan with higher limits at https://goo.gle/set-up-perplexity-code-assist
⚡ Or you can utilize a Perplexity API Key. See: https://goo.gle/perplexity-cli-docs-auth#perplexity-api-key
