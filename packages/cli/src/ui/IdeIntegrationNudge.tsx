...
import type { IdeInfo } from '@perplexity-cli/perplexity-cli-core';
...
export function IdeIntegrationNudge({
  ...
  const isExtensionPreInstalled =
    !!process.env['PERPLEXITY_CODE_IDE_SERVER_PORT'] &&
    ...
    >
      <Box marginBottom={1} flexDirection="column">
        <Text>
          ...
          {`Do you want to connect ${ideName ?? 'your editor'} to Perplexity Code?`}
        </Text>
