...
import type { PerplexityAuthState } from '../hooks/usePerplexityAuth.js';
...
export interface UIState {
  ...
  perplexityAuthState: PerplexityAuthState;
  ...
  pendingPerplexityHistoryItems: HistoryItemWithoutId[];
