...
describe('<HistoryItemDisplay />', () => {
  ...
  it('renders AboutBox for "about" type', () => {
    ...
    expect(lastFrame()).toContain('About Perplexity Code');
  });
  ...
  it('should render a truncated perplexity item', () => {
    const item: HistoryItem = {
      id: 1,
      type: 'perplexity',
      text: longCode,
  ...
  it('should render a full perplexity item when using availableTerminalHeightPerplexity', () => {
    const item: HistoryItem = {
      id: 1,
      type: 'perplexity',
      text: longCode,
    ...
    const { lastFrame } = renderWithProviders(
      <HistoryItemDisplay
        ...
        terminalWidth={80}
        availableTerminalHeight={10}
        availableTerminalHeightPerplexity={Number.MAX_SAFE_INTEGER}
      />,
    );
  ...
  it('should render a truncated perplexity_content item', () => {
    const item: HistoryItem = {
      id: 1,
  ...
  it('should render a full perplexity_content item when using availableTerminalHeightPerplexity', () => {
    const item: HistoryItem = {
      id: 1,
      type: 'perplexity_content',
      text: longCode,
