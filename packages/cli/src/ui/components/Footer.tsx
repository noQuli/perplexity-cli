...
import { shortenPath, tildeifyPath } from '@perplexity-cli/perplexity-cli-core';
...
export const Footer: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {!hideSandboxStatus && (
        ...
        >
          {isTrustedFolder === false ? (
            ...
            <Text color="green">
              {process.env['SANDBOX'].replace(/^perplexity-(?:cli-)?/, '')}
            </Text>
          ) : process.env['SANDBOX'] === 'sandbox-exec' ? (
      ...
      {/* Right Section: Perplexity Label and Console Summary */}
      {!hideModelInfo && (
