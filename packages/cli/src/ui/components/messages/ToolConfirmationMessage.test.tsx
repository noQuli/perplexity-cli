...
describe('ToolConfirmationMessage', () => {
  ...
  it('should display urls if prompt and url are different', () => {
    const confirmationDetails: ToolCallConfirmationDetails = {
      ...
      title: 'Confirm Web Fetch',
      prompt:
        'fetch https://github.com/google/perplexity-react/blob/main/README.md',
      urls: [
        'https://raw.githubusercontent.com/google/perplexity-react/main/README.md',
      ],
      onConfirm: vi.fn(),
    };
    ...
    // URL may be wrapped across lines, so check for key parts
    expect(lastFrame()).toContain('raw.githubusercontent.com');
  });
