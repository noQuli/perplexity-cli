...
describe('<ContextSummaryDisplay />', () => {
  const baseProps = {
    perplexityMdFileCount: 1,
    contextFileNames: ['PERPLEXITY.md'],
  ...
  it('should render on a single line on a wide screen', () => {
    ...
    expect(output).toContain(
      'Using: 1 open file (ctrl+g to view) | 1 PERPLEXITY.md file | 1 MCP server (ctrl+t to view)',
    );
