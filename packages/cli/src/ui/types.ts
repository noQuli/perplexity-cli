...
export interface HistoryItemBase {
  text?: string; // Text content for user/perplexity/info/error messages
}
...
export type HistoryItemPerplexity = HistoryItemBase & {
  type: 'perplexity';
  text: string;
};

export type HistoryItemPerplexityContent = HistoryItemBase & {
  type: 'perplexity_content';
  text: string;
};

export type HistoryItemPerplexityThought = HistoryItemBase & {
  type: 'perplexity_thought';
  text: string;
};

export type HistoryItemPerplexityThoughtContent = HistoryItemBase & {
  type: 'perplexity_thought_content';
  text: string;
};
...
export type HistoryItemWithoutId =
  ...
  | HistoryItemPerplexity
  | HistoryItemPerplexityContent
  | HistoryItemPerplexityThought
  | HistoryItemPerplexityThoughtContent
  | HistoryItemInfo
  | HistoryItemError
  | HistoryItemWarning
  | HistoryItemAbout
 ...
 * being submitted to the Perplexity model.
 */
...
/**
 * Defines the result of the slash command processor for its consumer (usePerplexityStream).
 */
