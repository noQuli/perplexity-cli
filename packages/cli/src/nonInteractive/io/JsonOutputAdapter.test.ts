...
import { PerplexityEventType } from '@perplexity-cli/perplexity-cli-core';
...
describe('JsonOutputAdapter', () => {
  ...
  describe('processEvent', () => {
    ...
    it('should append text content from Content events', () => {
      const event: ServerPerplexityStreamEvent = {
        type: PerplexityEventType.Content,
        value: 'Hello',
      };
      adapter.processEvent(event);

      const event2: ServerPerplexityStreamEvent = {
        type: PerplexityEventType.Content,
        value: ' World',
      };
    ...
    it('should ignore non-string citation values', () => {
      const event: ServerPerplexityStreamEvent = {
        type: PerplexityEventType.Citation,
        value: 123,
      } as unknown as ServerPerplexityStreamEvent;
      adapter.processEvent(event);
