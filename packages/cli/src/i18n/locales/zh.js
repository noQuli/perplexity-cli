...
// Chinese translations for Perplexity CLI CLI
...
export default {
  ...
  'for help on Perplexity CLI': '获取 Perplexity CLI 帮助',
  'show version info': '显示版本信息',
  'submit a bug report': '提交错误报告',
  'About Perplexity CLI': '关于 Perplexity CLI',
  ...
  // Commands - General
  // ============================================================================
  'Analyzes the project and creates a tailored PERPLEXITY.md file.':
    '分析项目并创建定制的 PERPLEXITY.md 文件',
  'list available Perplexity CLI tools. Usage: /tools [desc]':
    '列出可用的 Perplexity CLI 工具。用法：/tools [desc]',
  'Available Perplexity CLI CLI tools:': '可用的 Perplexity CLI CLI 工具：',
  ...
  'Compresses the context by replacing it with a summary.':
    '通过用摘要替换来压缩上下文',
  'open full Perplexity CLI documentation in your browser':
    '在浏览器中打开完整的 Perplexity CLI 文档',
  ...
  // ============================================================================
  'Project Level (.perplexity/agents/)': '项目级 (.perplexity/agents/)',
  'User Level (~/.perplexity/agents/)': '用户级 (~/.perplexity/agents/)',
  ...
  'Generate with Perplexity CLI (Recommended)':
    '使用 Perplexity CLI 生成（推荐）',
  ...
  // ============================================================================
  'View and edit Perplexity CLI settings': '查看和编辑 Perplexity CLI 设置',
  Settings: '设置',
  '(Use Enter to select{{tabText}})': '（使用 Enter 选择{{tabText}}）',
  ', Tab to change focus': '，Tab 切换焦点',
  'To see changes, Perplexity CLI must be restarted. Press r to exit and apply changes now.':
    '要查看更改，必须重启 Perplexity CLI。按 r 退出并立即应用更改。',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Vim 模式',
  ...
  'Respect .perplexityignore': '遵守 .perplexityignore',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Perplexity CLI in one of these supported IDEs: VS Code or VS Code forks.':
    '您当前环境不支持 IDE 集成。要使用此功能，请在以下支持的 IDE 之一中运行 Perplexity CLI：VS Code 或 VS Code 分支版本。',
  ...
  // Commands - Summary
  // ============================================================================
  'Generate a project summary and save it to .perplexity/PROJECT_SUMMARY.md':
    '生成项目摘要并保存到 .perplexity/PROJECT_SUMMARY.md',
  ...
  'Successfully added PERPLEXITY.md files from the following directories if there are:\n- {{directories}}':
    '如果存在，已成功从以下目录添加 PERPLEXITY.md 文件：\n- {{directories}}',
  ...
  'Terms of Services and Privacy Notice for Perplexity CLI':
    'Perplexity CLI 的服务条款和隐私声明',
  'Perplexity OAuth': 'Perplexity OAuth (免费)',
  OpenAI: 'OpenAI',
  'Failed to login. Message: {{message}}': '登录失败。消息：{{message}}',
  'Authentication is enforced to be {{enforcedType}}, but you are currently using {{currentType}}.':
    '认证方式被强制设置为 {{enforcedType}}，但您当前使用的是 {{currentType}}',
  'Perplexity OAuth authentication timed out. Please try again.':
    'Perplexity OAuth 认证超时。请重试',
  'Perplexity OAuth authentication cancelled.': 'Perplexity OAuth 认证已取消',
  'Perplexity OAuth Authentication': 'Perplexity OAuth 认证',
  ...
  'Perplexity OAuth Authentication Timeout': 'Perplexity OAuth 认证超时',
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuth 令牌已过期（超过 {{seconds}} 秒）。请重新选择认证方法',
  'Press any key to return to authentication type selection.':
    '按任意键返回认证类型选择',
  'Waiting for Perplexity OAuth authentication...':
    '正在等待 Perplexity OAuth 认证...',
  'Note: Your existing API key in settings.json will not be cleared when using Perplexity OAuth. You can switch back to OpenAI authentication later if needed.':
    '注意：使用 Perplexity OAuth 时，settings.json 中现有的 API 密钥不会被清除。如果需要，您可以稍后切换回 OpenAI 认证。',
  ...
  'Invalid PERPLEXITY_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    '无效的 PERPLEXITY_DEFAULT_AUTH_TYPE 值："{{value}}"。有效值为：{{validValues}}',
  ...
  'The latest Perplexity CLIr model from Perplexity Cloud ModelStudio (version: perplexity3-coder-plus-2025-09-23)':
    '来自阿里云 ModelStudio 的最新 Perplexity CLIr 模型（版本：perplexity3-coder-plus-2025-09-23）',
  'The latest Perplexity Vision model from Perplexity Cloud ModelStudio (version: perplexity3-vl-plus-2025-09-23)':
    '来自阿里云 ModelStudio 的最新 Perplexity Vision 模型（版本：perplexity3-vl-plus-2025-09-23）',
  ...
  'files to customize your interactions with Perplexity CLI.':
    '文件以自定义您与 Perplexity CLI 的交互',
  'for more information.': '获取更多信息',

  // ============================================================================
  // Exit Screen / Stats
  // ============================================================================
  'Agent powering down. Goodbye!': 'Perplexity CLI 正在关闭，再见！',
