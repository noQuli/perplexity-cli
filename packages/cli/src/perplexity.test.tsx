...
import { OutputFormat } from '@perplexity-cli/perplexity-cli-core';
...
describe('perplexity.tsx main function', () => {
  let originalEnvPerplexitySandbox: string | undefined;
  ...
  beforeEach(() => {
    ...
    originalEnvPerplexitySandbox = process.env['PERPLEXITY_SANDBOX'];
    originalEnvSandbox = process.env['SANDBOX'];
    delete process.env['PERPLEXITY_SANDBOX'];
  ...
  afterEach(() => {
    ...
    if (originalEnvPerplexitySandbox !== undefined) {
      process.env['PERPLEXITY_SANDBOX'] = originalEnvPerplexitySandbox;
    } else {
      delete process.env['PERPLEXITY_SANDBOX'];
    }
...
describe('perplexity.tsx main function kitty protocol', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvNoRelaunch = process.env['PERPLEXITY_CLI_NO_RELAUNCH'];
    process.env['PERPLEXITY_CLI_NO_RELAUNCH'] = 'true';
  ...
  afterEach(() => {
    ...
    if (originalEnvNoRelaunch !== undefined) {
      process.env['PERPLEXITY_CLI_NO_RELAUNCH'] = originalEnvNoRelaunch;
    } else {
      delete process.env['PERPLEXITY_CLI_NO_RELAUNCH'];
    }
  });
