...
import { IdeClient } from '@perplexity-cli/perplexity-cli-core';
...
describe('systemInfo', () => {
  ...
  describe('getSandboxEnv', () => {
    ...
    it('should return sandbox name without prefix when stripPrefix is true', () => {
      process.env['SANDBOX'] = 'perplexity-code-test-sandbox';
      expect(getSandboxEnv(true)).toBe('test-sandbox');
    });

    it('should return sandbox name with prefix when stripPrefix is false', () => {
      process.env['SANDBOX'] = 'perplexity-code-test-sandbox';
      expect(getSandboxEnv(false)).toBe('perplexity-code-test-sandbox');
    });

    it('should handle perplexity- prefix removal', () => {
      process.env['SANDBOX'] = 'perplexity-custom-sandbox';
  ...
  describe('getExtendedSystemInfo', () => {
    it('should include memory usage and base URL', async () => {
      ...
      const { AuthType } = await import('@perplexity-cli/perplexity-cli-core');
