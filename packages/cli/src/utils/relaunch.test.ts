...
describe('relaunchAppInChildProcess', () => {
  ...
  describe('when PERPLEXITY_CLI_NO_RELAUNCH is set', () => {
  ...
  describe('when PERPLEXITY_CLI_NO_RELAUNCH is not set', () => {
    beforeEach(() => {
      delete process.env['PERPLEXITY_CLI_NO_RELAUNCH'];
    });
    ...
    it('should construct correct node arguments from execArgv, additionalNodeArgs, script, additionalScriptArgs, and argv', () => {
      ...
      const additionalScriptArgs = ['--model', 'perplexity-1.5-pro', '--debug'];
