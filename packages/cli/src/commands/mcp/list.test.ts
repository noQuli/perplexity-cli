...
import { createTransport } from '@perplexity-cli/perplexity-cli-core';
...
vi.mock('@perplexity-cli/perplexity-cli-core', () => ({
  ...
  Storage: vi.fn().mockImplementation((_cwd: string) => ({
    getGlobalSettingsPath: () => '/tmp/perplexity/settings.json',
    getWorkspaceSettingsPath: () => '/tmp/perplexity/workspace-settings.json',
    getProjectTempDir: () => '/test/home/.perplexity/tmp/mocked_hash',
  })),
