...
// File for 'perplexity mcp add' command
import type { CommandModule } from 'yargs';
import { loadSettings, SettingScope } from '../../config/settings.js';
import type { MCPServerConfig } from '@perplexity-cli/perplexity-cli-core';
...
export const addCommand: CommandModule = {
  ...
  builder: (yargs) =>
    yargs
      .usage(
        'Usage: perplexity mcp add [options] <name> <commandOrUrl> [args...]',
      )
      .parserConfiguration({
