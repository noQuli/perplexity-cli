...
vi.mock('../tools/memoryTool.js', () => ({
  getCurrentPerplexityMdFilename: vi.fn(() => 'PERPLEXITY.md'),
}));
...
describe('FileExclusions', () => {
  ...
  describe('getDefaultExcludePatterns', () => {
    it('should return comprehensive patterns by default', () => {
      ...
      expect(patterns).toContain('**/PERPLEXITY.md');
    });
    ...
    it('should respect includeDefaults option', () => {
      ...
      expect(patterns).not.toContain('**/PERPLEXITY.md');
    ...
    it('should respect includeDynamicPatterns option', () => {
      ...
      expect(patternsWithDynamic).toContain('**/PERPLEXITY.md');
      expect(patternsWithoutDynamic).not.toContain('**/PERPLEXITY.md');
    });
  });
