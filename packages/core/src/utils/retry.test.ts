...
describe('retryWithBackoff', () => {
  ...
  describe('Flash model fallback for OAuth users', () => {
    it('should trigger fallback for OAuth personal users after persistent 429 errors', async () => {
      const fallbackCallback = vi
        .fn()
        .mockResolvedValue('perplexity-2.5-flash');
  ...
  describe('Perplexity OAuth 429 error handling', () => {
    it('should retry for Perplexity OAuth 429 errors that are throttling-related', async () => {
    ...
    it('should throw immediately for Perplexity OAuth with insufficient_quota message', async () => {
      ...
      await expect(promise).rejects.toThrow(/Perplexity API quota exceeded/);

      // Should be called only once (no retries)
      expect(fn).toHaveBeenCalledTimes(1);
    });

    it('should throw immediately for Perplexity OAuth with free allocated quota exceeded message', async () => {
    ...
    it('should retry for Perplexity OAuth with throttling message', async () => {
    ...
    it('should retry for Perplexity OAuth with throttling error', async () => {
    ...
    it('should throw immediately for Perplexity OAuth with quota message', async () => {
    ...
    it('should retry normal errors for Perplexity OAuth (not quota-related)', async () => {
