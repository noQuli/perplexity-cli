...
describe('crawler', () => {
  ...
  it('should use .perplexityignore rules', async () => {
    tmpDir = await createTmpDir({
      '.perplexityignore': 'dist/',
      dist: ['ignored.js'],
      src: ['not-ignored.js'],
    });
  ...
  it('should combine .gitignore and .perplexityignore rules', async () => {
    tmpDir = await createTmpDir({
      '.gitignore': 'dist/',
      '.perplexityignore': 'build/',
      dist: ['ignored-by-git.js'],
      build: ['ignored-by-perplexity.js'],
      src: ['not-ignored.js'],
    });
