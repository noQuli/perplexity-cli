      ...
      if (entry.isFile()) {
        ...
        if (options.fileService) {
          const shouldIgnore =
            ...
            (options.fileFilteringOptions.respectPerplexityIgnore &&
              options.fileService.shouldPerplexityIgnoreFile(filePath));
          if (shouldIgnore) {
            continue;
          }
        }
      ...
      if (entry.isDirectory()) {
        ...
        if (options.fileService) {
          isIgnored =
            ...
            (options.fileFilteringOptions.respectPerplexityIgnore &&
              options.fileService.shouldPerplexityIgnoreFile(subFolderPath));
        }
