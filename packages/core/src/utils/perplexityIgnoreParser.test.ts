...
import { PerplexityIgnoreParser } from './perplexityIgnoreParser.js';
import * as fs from 'node:fs/promises';
import * as path from 'node:path';
import * as os from 'node:os';

describe('PerplexityIgnoreParser', () => {
  ...
  beforeEach(async () => {
    projectRoot = await fs.mkdtemp(
      path.join(os.tmpdir(), 'perplexityignore-test-'),
    );
  });
  ...
  describe('when .perplexityignore exists', () => {
    beforeEach(async () => {
    ...
    it('should ignore files specified in .perplexityignore', () => {
      const parser = new PerplexityIgnoreParser(projectRoot);
  ...
  describe('when .perplexityignore does not exist', () => {
