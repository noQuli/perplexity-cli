...
describe('Flash Model Fallback Configuration', () => {
  ...
  describe('setModel', () => {
    it('should only mark as switched if contentGeneratorConfig exists', async () => {
      ...
      await newConfig.setModel(DEFAULT_PERPLEXITY_FLASH_MODEL);
  ...
  describe('getModel', () => {
    it('should return contentGeneratorConfig model if available', async () => {
      ...
      await config.setModel(DEFAULT_PERPLEXITY_FLASH_MODEL);
      expect(config.getModel()).toBe(DEFAULT_PERPLEXITY_FLASH_MODEL);
    });
