...
const PERPLEXITY_CONFIG_DIR = '.perplexity';
...
export class SubagentManager {
  ...
  getSubagentPath(name: string, level: SubagentLevel): string {
    ...
    const baseDir =
      level === 'project'
        ...
        : path.join(os.homedir(), PERPLEXITY_CONFIG_DIR, AGENT_CONFIG_DIR);
  ...
  private async listSubagentsAtLevel(
    ...
    baseDir = path.join(baseDir, PERPLEXITY_CONFIG_DIR, AGENT_CONFIG_DIR);
