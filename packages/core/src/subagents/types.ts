 ...
 * - 'project': Stored in `.perplexity/agents/` within the project directory
 * - 'user': Stored in `~/.perplexity/agents/` in the user's home directory
...
export interface ModelConfig {
  /**
   * The name or identifier of the model to be used (e.g., 'perplexity3-coder-plus').
   *
