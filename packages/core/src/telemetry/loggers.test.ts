...
describe('loggers', () => {
  ...
  describe('logChatCompression', () => {
    beforeEach(() => {
      ...
      vi.spyOn(PerplexityLogger.prototype, 'logChatCompressionEvent');
    });

    it('logs the chat compression event to PerplexityLogger', () => {
      ...
      expect(
        PerplexityLogger.prototype.logChatCompressionEvent,
  ...
  describe('logRipgrepFallback', () => {
    ...
    beforeEach(() => {
      vi.spyOn(PerplexityLogger.prototype, 'logRipgrepFallbackEvent');
    });
    ...
    it('should log ripgrep fallback event', () => {
      ...
      expect(
        PerplexityLogger.prototype.logRipgrepFallbackEvent,
      ).toHaveBeenCalled();
  ...
  describe('logToolCall', () => {
    const cfg1 = {
      getSessionId: () => 'test-session-id',
      getTargetDir: () => 'target-dir',
      getPerplexityClient: () => mockPerplexityClient,
    } as Config;
    const cfg2 = {
      getSessionId: () => 'test-session-id',
      getTargetDir: () => 'target-dir',
    ...
    const mockPerplexityClient = new PerplexityClient(cfg2);
    const mockConfig = {
      getSessionId: () => 'test-session-id',
      getTargetDir: () => 'target-dir',
      getPerplexityClient: () => mockPerplexityClient,
  ...
  describe('logMalformedJsonResponse', () => {
    beforeEach(() => {
      vi.spyOn(PerplexityLogger.prototype, 'logMalformedJsonResponseEvent');
    });
    ...
    it('logs the event to Clearcut and OTEL', () => {
      ...
      expect(
        PerplexityLogger.prototype.logMalformedJsonResponseEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionInstall', () => {
    ...
    beforeEach(() => {
      vi.spyOn(PerplexityLogger.prototype, 'logExtensionInstallEvent');
    });
    ...
    it('should log extension install event', () => {
      ...
      expect(
        PerplexityLogger.prototype.logExtensionInstallEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionUninstall', () => {
    ...
    beforeEach(() => {
      vi.spyOn(PerplexityLogger.prototype, 'logExtensionUninstallEvent');
    });
    ...
    it('should log extension uninstall event', () => {
      ...
      expect(
        PerplexityLogger.prototype.logExtensionUninstallEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionEnable', () => {
    ...
    beforeEach(() => {
      vi.spyOn(PerplexityLogger.prototype, 'logExtensionEnableEvent');
    });
    ...
    it('should log extension enable event', () => {
      ...
      expect(
        PerplexityLogger.prototype.logExtensionEnableEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionDisable', () => {
    ...
    beforeEach(() => {
      vi.spyOn(PerplexityLogger.prototype, 'logExtensionDisableEvent');
    });
    ...
    it('should log extension disable event', () => {
      ...
      expect(
        PerplexityLogger.prototype.logExtensionDisableEvent,
      ).toHaveBeenCalledWith(event);
