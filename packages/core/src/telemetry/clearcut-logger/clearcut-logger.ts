...
export interface EventValue {
  perplexity_cli_key: EventMetadataKey;
  value: string;
}

export interface LogEvent {
  console_type: 'PERPLEXITY_CLI';
  application: number;
  event_name: string;
 ...
 * distribution channel in which the user is using Perplexity CLI.  Perplexity CLI comes bundled
...
export class ClearcutLogger {
  ...
  createLogEvent(eventName: EventNames, data: EventValue[] = []): LogEvent {
    ...
    const logEvent: LogEvent = {
      console_type: 'PERPLEXITY_CLI',
      application: 102, // PERPLEXITY_CLI
  ...
  logStartSessionEvent(event: StartSessionEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_START_SESSION_MODEL,
        value: event.model,
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_EMBEDDING_MODEL,
        value: event.embedding_model,
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_SANDBOX,
        value: event.sandbox_enabled.toString(),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_CORE_TOOLS,
        value: event.core_tools_enabled,
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_APPROVAL_MODE,
        value: event.approval_mode,
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_API_KEY_ENABLED,
        value: event.api_key_enabled.toString(),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_VERTEX_API_ENABLED,
        value: event.vertex_ai_enabled.toString(),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_DEBUG_MODE_ENABLED,
      ...
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_MCP_SERVERS,
      ...
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_TELEMETRY_ENABLED,
        value: event.telemetry_enabled.toString(),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_TELEMETRY_LOG_USER_PROMPTS_ENABLED,
        value: event.telemetry_log_user_prompts_enabled.toString(),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_MCP_SERVERS_COUNT,
      ...
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_MCP_TOOLS_COUNT,
        value: event.mcp_tools_count?.toString() ?? '',
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_START_SESSION_MCP_TOOLS,
  ...
  logNewPromptEvent(event: UserPromptEvent): void {
    ...
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_USER_PROMPT_LENGTH,
  ...
  logToolCallEvent(event: ToolCallEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_TOOL_CALL_NAME,
        value: JSON.stringify(event.function_name),
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_TOOL_CALL_DECISION,
        value: JSON.stringify(event.decision),
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_TOOL_CALL_SUCCESS,
        value: JSON.stringify(event.success),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_TOOL_CALL_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_TOOL_ERROR_MESSAGE,
        value: JSON.stringify(event.error),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_TOOL_CALL_ERROR_TYPE,
        value: JSON.stringify(event.error_type),
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_TOOL_TYPE,
        value: JSON.stringify(event.tool_type),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_TOOL_CALL_CONTENT_LENGTH,
        value: JSON.stringify(event.content_length),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_TOOL_CALL_MCP_SERVER_NAME,
    ...
    if (event.metadata) {
      const metadataMapping: { [key: string]: EventMetadataKey } = {
        model_added_lines: EventMetadataKey.PERPLEXITY_CLI_AI_ADDED_LINES,
        model_removed_lines: EventMetadataKey.PERPLEXITY_CLI_AI_REMOVED_LINES,
        model_added_chars: EventMetadataKey.PERPLEXITY_CLI_AI_ADDED_CHARS,
        model_removed_chars: EventMetadataKey.PERPLEXITY_CLI_AI_REMOVED_CHARS,
        user_added_lines: EventMetadataKey.PERPLEXITY_CLI_USER_ADDED_LINES,
        user_removed_lines: EventMetadataKey.PERPLEXITY_CLI_USER_REMOVED_LINES,
        user_added_chars: EventMetadataKey.PERPLEXITY_CLI_USER_ADDED_CHARS,
        user_removed_chars: EventMetadataKey.PERPLEXITY_CLI_USER_REMOVED_CHARS,
      };

      for (const [key, perplexity_cli_key] of Object.entries(metadataMapping)) {
  ...
  logFileOperationEvent(event: FileOperationEvent): void {
    const data: EventValue[] = [
      ...
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_FILE_OPERATION_TYPE,
        value: JSON.stringify(event.operation),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_FILE_OPERATION_LINES,
        value: JSON.stringify(event.lines),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_FILE_OPERATION_MIMETYPE,
        value: JSON.stringify(event.mimetype),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_FILE_OPERATION_EXTENSION,
    ...
    if (event.programming_language) {
      data.push({
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_PROGRAMMING_LANGUAGE,
  ...
  logApiRequestEvent(event: ApiRequestEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_API_REQUEST_MODEL,
  ...
  logApiResponseEvent(event: ApiResponseEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_API_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_API_RESPONSE_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_API_RESPONSE_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_API_RESPONSE_INPUT_TOKEN_COUNT,
        value: JSON.stringify(event.input_token_count),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT,
        value: JSON.stringify(event.output_token_count),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_API_RESPONSE_CACHED_TOKEN_COUNT,
        value: JSON.stringify(event.cached_content_token_count),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_API_RESPONSE_THINKING_TOKEN_COUNT,
        value: JSON.stringify(event.thoughts_token_count),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_API_RESPONSE_TOOL_TOKEN_COUNT,
  ...
  logApiErrorEvent(event: ApiErrorEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_API_ERROR_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_API_ERROR_TYPE,
        value: JSON.stringify(event.error_type),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_API_ERROR_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_API_ERROR_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
    ];
  ...
  logChatCompressionEvent(event: ChatCompressionEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_COMPRESSION_TOKENS_BEFORE,
        value: `${event.tokens_before}`,
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_COMPRESSION_TOKENS_AFTER,
  ...
  logLoopDetectedEvent(event: LoopDetectedEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_LOOP_DETECTED_TYPE,
  ...
  logNextSpeakerCheck(event: NextSpeakerCheckEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_RESPONSE_FINISH_REASON,
        value: JSON.stringify(event.finish_reason),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_NEXT_SPEAKER_CHECK_RESULT,
  ...
  logSlashCommandEvent(event: SlashCommandEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_SLASH_COMMAND_NAME,
    ...
    if (event.subcommand) {
      data.push({
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_SLASH_COMMAND_SUBCOMMAND,
    ...
    if (event.status) {
      data.push({
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_SLASH_COMMAND_STATUS,
  ...
  logMalformedJsonResponseEvent(event: MalformedJsonResponseEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_MALFORMED_JSON_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
    ];
  ...
  logIdeConnectionEvent(event: IdeConnectionEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_IDE_CONNECTION_TYPE,
  ...
  logConversationFinishedEvent(event: ConversationFinishedEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_SESSION_ID,
        value: this.config?.getSessionId() ?? '',
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_CONVERSATION_TURN_COUNT,
        value: JSON.stringify(event.turnCount),
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_APPROVAL_MODE,
  ...
  logKittySequenceOverflowEvent(event: KittySequenceOverflowEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_KITTY_SEQUENCE_LENGTH,
        value: event.sequence_length.toString(),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_KITTY_TRUNCATED_SEQUENCE,
  ...
  logInvalidChunkEvent(event: InvalidChunkEvent): void {
    ...
    if (event.error_message) {
      data.push({
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_INVALID_CHUNK_ERROR_MESSAGE,
  ...
  logContentRetryEvent(event: ContentRetryEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_CONTENT_RETRY_ATTEMPT_NUMBER,
        value: String(event.attempt_number),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_CONTENT_RETRY_ERROR_TYPE,
        value: event.error_type,
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_CONTENT_RETRY_DELAY_MS,
  ...
  logContentRetryFailureEvent(event: ContentRetryFailureEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_CONTENT_RETRY_FAILURE_TOTAL_ATTEMPTS,
        value: String(event.total_attempts),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_CONTENT_RETRY_FAILURE_FINAL_ERROR_TYPE,
    ...
    if (event.total_duration_ms) {
      data.push({
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_CONTENT_RETRY_FAILURE_TOTAL_DURATION_MS,
  ...
  logExtensionInstallEvent(event: ExtensionInstallEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_EXTENSION_NAME,
        value: event.extension_name,
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_EXTENSION_VERSION,
        value: event.extension_version,
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_EXTENSION_SOURCE,
        value: event.extension_source,
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_EXTENSION_INSTALL_STATUS,
        value: event.status,
      },
    ];
  ...
  logExtensionUninstallEvent(event: ExtensionUninstallEvent): void {
    const data: EventValue[] = [
      ...
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_EXTENSION_UNINSTALL_STATUS,
        value: event.status,
      },
    ];
  ...
  logToolOutputTruncatedEvent(event: ToolOutputTruncatedEvent): void {
    const data: EventValue[] = [
      ...
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_TOOL_OUTPUT_TRUNCATED_ORIGINAL_LENGTH,
        value: JSON.stringify(event.original_content_length),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_TOOL_OUTPUT_TRUNCATED_TRUNCATED_LENGTH,
        value: JSON.stringify(event.truncated_content_length),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_TOOL_OUTPUT_TRUNCATED_THRESHOLD,
        value: JSON.stringify(event.threshold),
      },
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_TOOL_OUTPUT_TRUNCATED_LINES,
        value: JSON.stringify(event.lines),
      },
    ];
  ...
  logExtensionEnableEvent(event: ExtensionEnableEvent): void {
    const data: EventValue[] = [
      ...
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_EXTENSION_ENABLE_SETTING_SCOPE,
  ...
  logModelSlashCommandEvent(event: ModelSlashCommandEvent): void {
    const data: EventValue[] = [
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_MODEL_SLASH_COMMAND,
  ...
  logExtensionDisableEvent(event: ExtensionDisableEvent): void {
    const data: EventValue[] = [
      ...
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_EXTENSION_DISABLE_SETTING_SCOPE,
        value: event.setting_scope,
      },
    ];
  ...
  addDefaultFields(data: EventValue[], totalAccounts: number): EventValue[] {
    ...
    const defaultLogMetadata: EventValue[] = [
      ...
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_AUTH_TYPE,
      ...
      {
        perplexity_cli_key:
          EventMetadataKey.PERPLEXITY_CLI_GOOGLE_ACCOUNTS_COUNT,
        value: `${totalAccounts}`,
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_SURFACE,
        value: surface,
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_VERSION,
        value: CLI_VERSION,
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_GIT_COMMIT_HASH,
        value: GIT_COMMIT_INFO,
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_PROMPT_ID,
        value: this.promptId,
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_OS,
        value: process.platform,
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_NODE_VERSION,
        value: process.versions.node,
      },
      {
        perplexity_cli_key: EventMetadataKey.PERPLEXITY_CLI_USER_SETTINGS,
