...
describe('TaskTool', () => {
  ...
  const mockSubagents: SubagentConfig[] = [
    {
      ...
      level: 'project',
      filePath: '/project/.perplexity/agents/file-search.md',
    },
    {
      name: 'code-review',
      ...
      level: 'user',
      filePath: '/home/user/.perplexity/agents/code-review.md',
    },
  ];
  ...
  beforeEach(async () => {
    ...
    config = {
      ...
      getPerplexityClient: vi.fn().mockReturnValue(undefined),
      ...
      const newSubagents: SubagentConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.perplexity/agents/new-agent.md',
        },
      ];
      ...
      const newSubagents: SubagentConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.perplexity/agents/test-agent.md',
        },
      ];
