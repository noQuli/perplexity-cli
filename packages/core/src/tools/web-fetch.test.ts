...
const mockGetPerplexityClient = vi.fn(() => ({
...
describe('WebFetchTool', () => {
  ...
  describe('shouldConfirmExecute', () => {
    ...
    it('should return github urls as-is in confirmation details', async () => {
      const tool = new WebFetchTool(mockConfig);
      const params = {
        url: 'https://github.com/google/perplexity-react/blob/main/README.md',
      ...
      expect(confirmationDetails).toEqual({
        ...
        title: 'Confirm Web Fetch',
        prompt:
          'Fetch content from https://github.com/google/perplexity-react/blob/main/README.md and process with: summarize the README',
        urls: [
          'https://github.com/google/perplexity-react/blob/main/README.md',
        ],
        onConfirm: expect.any(Function),
      });
    });
