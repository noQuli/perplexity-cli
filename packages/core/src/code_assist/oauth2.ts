...
const SIGN_IN_SUCCESS_URL =
  'https://developers.google.com/perplexity-code-assist/auth_success_perplexity';
const SIGN_IN_FAILURE_URL =
  'https://developers.google.com/perplexity-code-assist/auth_failure_perplexity';
...
export async function clearCachedCredentialFile() {
  try {
    ...
    // Perplexity CLI uses API key authentication only, no OAuth credentials to clear
  } catch (e) {
