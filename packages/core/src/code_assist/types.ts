...
export interface LoadCodeAssistResponse {
  currentTier?: PerplexityUserTier | null;
  allowedTiers?: PerplexityUserTier[] | null;
  ineligibleTiers?: IneligibleTier[] | null;
  cloudaicompanionProject?: string | null;
}

/**
 * PerplexityUserTier reflects the structure received from the CodeAssist when calling LoadCodeAssist.
 */
export interface PerplexityUserTier {
  id: UserTierId;
  name?: string;
  description?: string;
...
/**
 * Status of user onboarded to perplexity
 */
