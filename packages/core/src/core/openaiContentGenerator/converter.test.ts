...
describe('OpenAIContentConverter', () => {
  ...
  describe('convertPerplexityRequestToOpenAI', () => {
    ...
    it('should extract raw output from function response objects', () => {
      ...
      const messages = converter.convertPerplexityRequestToOpenAI(request);
  ...
  describe('OpenAI -> Perplexity reasoning content', () => {
    it('should convert reasoning_content to a thought part for non-streaming responses', () => {
      const response = converter.convertOpenAIResponseToPerplexity({
    ...
    it('should convert streaming reasoning_content delta to a thought part', () => {
      const chunk = converter.convertOpenAIChunkToPerplexity({
