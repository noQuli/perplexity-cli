...
describe('PerplexityChat', () => {
  ...
  beforeEach(() => {
    ...
    mockConfig = {
      ...
      getModel: vi.fn().mockReturnValue('perplexity-pro'),
      setModel: vi.fn(),
    ...
    chat = new PerplexityChat(mockConfig, config, []);
  });
  ...
  describe('Model Resolution', () => {
    ...
    it('should use the FLASH model when in fallback mode (sendMessageStream)', async () => {
      vi.mocked(mockConfig.getModel).mockReturnValue('perplexity-pro');
